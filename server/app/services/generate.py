...
def _build_markdown_prompt(
    ...
    instructions = (
        ...
        "input_imagesのpublic_urlはそれぞれ1回だけ使い、説明はaltとして反映してください。"
        ...
        "各プロンプトに「イラスト内に文字は含めない（文字禁止）」を必ず含めてください。"
...
def _build_html_prompt(
    ...
    instructions = (
        ...
        ".manual-image { width: 100%; max-width: 160mm; max-height: 90mm; height: auto; object-fit: contain; border: none; }"
        ".image-block img { max-width: 160mm !important; max-height: 90mm !important; }"
